...
var fusionBlogVars={"infinite_blog_text":"<em>Loading the next set of posts...<\/em>","infinite_finished_msg":"<em>All items displayed.<\/em>","slideshow_autoplay":"1","slideshow_speed":"7000","pagination_video_slide":"1","status_yt":"1","lightbox_behavior":"all","blog_pagination_type":"Infinite Scroll","flex_smoothHeight":"false"};var fusionFlexSliderVars={"status_vimeo":"1","page_smoothHeight":"false","slideshow_autoplay":"1","slideshow_speed":"7000","pagination_video_slide":"1","status_yt":"1","flex_smoothHeight":"false"};var fusionCarouselVars={"related_posts_speed":"2500","carousel_speed":"2500"};var fusionLightboxVars={"status_lightbox":"1","lightbox_gallery":"1","lightbox_skin":"metro-black","lightbox_title":"","lightbox_arrows":"1","lightbox_slideshow_speed":"5000","lightbox_autoplay":"","lightbox_opacity":"0.90","lightbox_desc":"","lightbox_social":"","lightbox_deeplinking":"1","lightbox_path":"horizontal","lightbox_post_images":"1","lightbox_animation_speed":"Fast"};function getAdminbarHeight(){var a=0;return jQuery("#wpadminbar").length&&(a=parseInt(jQuery("#wpadminbar").outerHeight(),10)),a}function getWaypointOffset(a){var b,c,d=a.data("animationoffset");return void 0===d&&(d="bottom-in-view"),"top-out-of-view"===d&&(b=getAdminbarHeight(),c="function"===getWaypointTopOffset?getWaypointTopOffset():0,d=b+c),d}jQuery(window).load(function(){setTimeout(function(){jQuery.waypoints("viewportHeight")},300)});
